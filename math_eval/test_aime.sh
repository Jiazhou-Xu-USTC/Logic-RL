...
CUDA_VISIBLE_DEVICES=0 python test_aime.py --stage 1 --step 420 > log/aime/1/420.log 2>&1 &
CUDA_VISIBLE_DEVICES=1 python test_aime.py --stage 1 --step 480 > log/aime/1/480.log 2>&1 &
CUDA_VISIBLE_DEVICES=2 python test_aime.py --stage 1 --step 600 > log/aime/1/600.log 2>&1 &
CUDA_VISIBLE_DEVICES=3 python test_aime.py --stage 1 --step 660 > log/aime/1/660.log 2>&1 &
